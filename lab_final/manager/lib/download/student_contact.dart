...
class student_contact extends StatefulWidget {
  @override
  _student_contactState createState() => _student_contactState();
}

class _student_contactState extends State<student_contact> {
